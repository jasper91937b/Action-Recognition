...
CLASSES = np.array(cfg_all["classes"]) # ['kick', 'opendoor', 'punch', 'run', 'sit', 'sos', 'stand']
...
# Input and output
SRC_ALL_SKELETONS_TXT = par(cfg["input"]["all_skeletons_txt"]) # data_proc/raw_skeletons/skeletons_info.txt
DST_PROCESSED_FEATURES = par(cfg["output"]["processed_features"]) # data_proc/features_X.csv
DST_PROCESSED_FEATURES_LABELS = par(cfg["output"]["processed_features_labels"]) # data_proc/features_Y.csv
