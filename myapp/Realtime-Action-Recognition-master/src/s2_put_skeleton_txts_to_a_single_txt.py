...
SRC_DETECTED_SKELETONS_FOLDER = par(cfg["input"]["detected_skeletons_folder"]) # data_proc/raw_skeletons/skeleton_res/
DST_ALL_SKELETONS_TXT = par(cfg["output"]["all_skeletons_txt"]) # data_proc/raw_skeletons/skeletons_info.txt
...
if __name__ == "__main__":
    ...
    with open("filelist.txt",'w') as results:
      for i in filepaths:
        results.write(i + "\n")

    # -- Check data length of one skeleton
    data_length = get_length_ofd_one_skeleton_data(filepaths)
